...
export const useSupercluster = (geojson, superclusterOptions) => {
	...
	// used to trigger pagge reload when the clusters when data was changed
	// same as what useState uses.
